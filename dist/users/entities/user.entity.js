...
exports.User = exports.Country = void 0;
...
let Country = exports.Country = class Country {
    id;
    name;
};
__decorate([
...
__decorate([
    (0, typeorm_1.Column)({ type: "enum", enum: Gender, default: Gender.Unknown }),
    __metadata("design:type", Number)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Country, { nullable: true }),
